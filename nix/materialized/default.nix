    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "hoard".components.tests."ghcib-test".planned = lib.mkOverride 900 true;
          ...
          "hoard".components.exes."ghcib-exe".planned = lib.mkOverride 900 true;
          ...
          "hoard".components.sublibs."ghcib".planned = lib.mkOverride 900 true;
