...
- [`atelier-core`](https://github.com/atelier-hub/atelier/tree/main/atelier-core) — this package
- [`atelier-db`](https://github.com/atelier-hub/atelier/tree/main/atelier-db) — relational database effect (Hasql/Rel8)
- [`atelier-testing`](https://github.com/atelier-hub/atelier/tree/main/atelier-testing) — database-backed test utilities
